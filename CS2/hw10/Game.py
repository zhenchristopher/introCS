...
def playGame(b, px, po):
    ...
    while True:
        if nextPlayerToMove == 'human':
            move = int(input("Enter a space to move in: "))
        else:
            move = nextPlayerToMove.nextMove(b)
        b.addMove(move,nextPieceToMove)
        print(b)
        ...
        if nextPlayerToMove == px:
            ...
            nextPlayerToMove = px
    print(str(nextPieceToMove) + " wins!")
